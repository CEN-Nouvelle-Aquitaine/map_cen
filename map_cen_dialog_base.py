...
class Ui_MapCENDialogBase(object):
    def setupUi(self, MapCENDialogBase):
        ...
        self.label_11.setGeometry(QtCore.QRect(260, 100, 621, 501))
        self.label_11.setText("")
        self.label_11.setPixmap(QtGui.QPixmap(":/plugins/map_cen/underconstruction.gif"))
        self.label_11.setScaledContents(True)
        self.label_11.setObjectName("label_11")
        self.label_13 = QtWidgets.QLabel(self.tab_3)
        self.label_13.setGeometry(QtCore.QRect(400, 540, 361, 41))
    ...
    def retranslateUi(self, MapCENDialogBase):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("MapCENDialogBase", "Accompagner, protéger, valoriser"))
